 ...
 * @author fa
 */
public class TableModelInferensi extends AbstractTableModel {

    private List<WeightAverage> list = new ArrayList<>();
    private TableRowSorter<TableModelInferensi> sorter;
    private DecimalFormat decimalFormat;

    public TableModelInferensi() {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch (columnIndex) {
            ...
            case 1:
                return list.get(rowIndex).getRule();
            case 2:
                return list.get(rowIndex).getThen();
            case 3:
    ...
    public TableRowSorter<TableModelInferensi> getSorter() {
        return sorter;
    }
